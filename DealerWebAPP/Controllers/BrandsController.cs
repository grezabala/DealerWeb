...
namespace DealerWebApp.DealertWeb.Controllers
{
    ...
    {
        private List<MBrands>? ListMBrands;
        private List<MBrands> GetMBrands()
        {
            List<MBrands> _ListMBrands = new List<MBrands>()
            {
                ...
                new MBrands()
                {
                    BrandId = 9,
                    NameBrand = "FIAT",
                    UrlImg = Url.Content("~/Tema/img marca/Logo/fiat-logo.webp")
                },
                ...
                new MBrands()
                {
                    BrandId = 31,
                    NameBrand = "DAIHATSU",
                    UrlImg = Url.Content("~/Tema/imgMarca/Logo/daihatsu-logo.webp")
                ...
                new MBrands()
                {
                    BrandId = 33,
                    NameBrand = "LOTUS",
                    UrlImg = Url.Content("~/Tema/imgMarca/Logo/lotus-logo-3d.webp")
                ...
                new MBrands()
                {
                    BrandId = 34,
                    NameBrand = "MARCK",
                    UrlImg = Url.Content("~/Tema/imgMarca/Logo/marck-logo-3d.webp")
                ...
                new MBrands()
                {
                    BrandId = 35,
                    NameBrand = "MASERATI",
                    UrlImg = Url.Content("~/Tema/imgMarca/Logo/maserati-logo-3d.webp")
                },
        ...
        {
            ListMBrands = GetMBrands();
            MBrands _mBrands = ListMBrands.FirstOrDefault(e => e.BrandId == Id)!;
            return View(_mBrands);
        }
